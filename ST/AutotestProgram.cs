...
namespace AlgorithmsDataStructures2
{
    ...
    public class SimpleTree<T>
    {
        ...
        public List<int> EvenTrees()
        {
            ...
            // подсчитать все узлы хранить счетчик всех узлов
            // создать список листов
            // начинать проход от каждого листа 
                //до тех пор пока родитель текущего узла не корень
                    // считать количество узлов родителя
                        // возможны три варианта в каждом из них выделять отдельный лес
            return null;
        }
